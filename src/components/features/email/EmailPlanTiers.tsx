...
export const EMAIL_PLANS = [
  {
    ...
    blurb: "One team seat with email alerts to opted-in teammates.",
    features: [
      "1 team seat (owner only)",
      "Unlimited in-site notifications",
      "Email alerts to opted-in teammates",
  ...
  },
  {
    ...
    blurb: "Up to 5 seats, plus confirmation emails to submitters.",
    featured: true,
    features: [
      "Up to 5 team seats",
      "Unlimited in-site notifications",
